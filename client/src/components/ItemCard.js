...
const ItemCard = (props) => {
    return (
        <Grid item xs={3}>
            <Paper elevation={3}>
                <img src={props.imagePath} alt='oops! not found' className='img'/>
                <Box padding={1}>
                    ...
                    <Box>
                        <Typography variant='body2'>{props.sellerName}</Typography><Typography variant="caption">{props.sellerRating}<Star sx={{pt:1.6, color:'orange'}}/></Typography>
                    </Box>
                </Box>
            </Paper>
        </Grid>
